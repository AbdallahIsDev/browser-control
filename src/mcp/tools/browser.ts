...
const BROWSER_STEP_PROPERTIES = {
  ...
  amount: { type: "number", description: "Scroll amount in pixels. Default: 300.", default: 300 },
  ...
  annotate: { type: "boolean", description: "Annotate screenshot steps with ref labels and boxes.", default: false },
  refs: { type: "string", description: "Comma-separated refs to annotate for screenshot steps when annotate is true." },
...

    {
      ...
      handler: async (params) => {
        ...
        return api.browser.act({
          ...
          fullPage: params.fullPage as boolean | undefined,
          annotate: params.annotate as boolean | undefined,
          refs: params.refs ? (params.refs as string).split(",").map((ref) => ref.trim()).filter(Boolean) : undefined,
          snapshot: params.snapshot as boolean | undefined,
          screenshot: params.screenshot as boolean | undefined,
          dialog: params.dialog as boolean | undefined,
          downloads: params.downloads as boolean | undefined,
