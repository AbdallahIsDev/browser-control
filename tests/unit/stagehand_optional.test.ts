...
test("missing Stagehand package reports the install command", async () => {
  ...
  const stagehandCorePath = require.resolve("../../src/browser/stagehand_core");
  ...
  try {
    const core = require("../../src/browser/stagehand_core") as typeof import("../../src/browser/stagehand_core");
